...
import "../VerEventoClient/VerEventoClient.css";
import { useEffect, useState } from "react";
import { getEventosClient } from "../../../../api/Api";
import VerEventoClient from "../VerEventoClient/VerEventoClient";
import M from "materialize-css";
import "materialize-css/dist/css/materialize.min.css";

export default function VistaEventoCliente() {
  ...
  const getDataEventos = async () => {
    ...
    setDatosObtenidos(eventosGeneral.length > 0);
  };

  const metododePaginacion = async () => {
                  ...
                  >
                    ...
                    <div className="row left-align">
                      ...
                      <div className="col s1 offset-s1">
                        <a
                          className="btn-floating btn waves-effect waves-light  red darken-1 tooltipped"
                          data-position="top"
